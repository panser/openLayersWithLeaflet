...
var bordersKommunegrenseLayer = L.tileLayer.wms('http://localhost:7070/geoserver/borders_Kommunegrense/wms', {
    layers: 'borders_Kommunegrense:ADM_enheter_Norge_Kommunegrense_KURVE',
    format: 'image/png',
    transparent: true
    //crs: crs
});
var bordersFylkesgrenseLayer = L.tileLayer.wms('http://localhost:7070/geoserver/borders_Fylkesgrense/wms', {
    layers: 'borders_Fylkesgrense:ADM_enheter_Norge_Fylkesgrense_KURVE',
    format: 'image/png',
    transparent: true
    //crs: crs
});
var bordersRiksgrenseLayer = L.tileLayer.wms('http://localhost:7070/geoserver/borders_Riksgrense/wms', {
    layers: 'borders_Riksgrense:ADM_enheter_Norge_Riksgrense_KURVE',
    format: 'image/png',
    transparent: true
    //crs: crs
});
var urbanRuralLayer = L.tileLayer.wms('http://localhost:7070/geoserver/urBanRural/wms', {
